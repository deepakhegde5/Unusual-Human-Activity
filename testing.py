...
def test_video(vid):
    ...
    np.save(r"C:\Users\Dee\Desktop\ABNORMAL-HUMAN-ACTIVITY-DETECTION-SYSTEM-main\Dataset\videos\scene1\megaBlockMotInfVal_set1_p1_test_20-20_k5.npy",megaBlockMotInfVal)
    ######megaBlockMotInfVal = np.load("megaBlockMotInfVal_set3_p2_train_40_k7.npy")
    codewords = np.load(r"C:\Users\Dee\Desktop\ABNORMAL-HUMAN-ACTIVITY-DETECTION-SYSTEM-main\Dataset\videos\scene1\codewords_set2_p1_train_20-20_k5.npy")
...
if __name__ == '__main__':
    ...
    '''
    testSet = [r"C:\Users\Dee\Desktop\ABNORMAL-HUMAN-ACTIVITY-DETECTION-SYSTEM-main\Dataset\videos\scene3\3_test1.avi"]
